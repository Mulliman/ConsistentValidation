...
{
    public class ConsistentDateInPastAttribute : ValidationAttribute, IConsistentValidationRuleAttribute
    {
        private string _displayName;

        public ConsistentDateInPastAttribute()
        {
            Rule = new DateInPastRule();
